...
const OrbitDbRouter = require('../../../../../src/controllers/rest-api/orbit-db')
let uut
let sandbox
// let ctx
...
describe('#Entry-REST-Router', () => {
  ...
  beforeEach(() => {
    ...
    uut = new OrbitDbRouter({ adapters, useCases })
  ...
  describe('#constructor', () => {
    ...
    it('should throw an error if useCases are not passed in', () => {
      try {
        uut = new OrbitDbRouter({ adapters })
